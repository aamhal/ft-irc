...
/*   Updated: 2024/09/27 10:56:35 by akaabi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Server::Invite(std::string &cmd, int &fd)
{
	...
	if (GetChannel(Name_channel)->GetLimit() && GetChannel(Name_channel)->GetClientsNumber() >= GetChannel(Name_channel)->GetLimit()) //channe full 
